...
const fileStream = new FileStream('logFile.txt')
	...
	.withFormat(
		new JsonFormatter().withPrettyPrintIndentation(2).withDateTimeFormat('YYYY.MM.DD hh:mm:ss:SSS'),
	)
	.withBufferSize(10000)
	.withLogFileInitMode('append')
	.withLogFileRotation(every(200000).bytes().withLogFileRetentionPolicy(of(7).days()))
	.withLogHeader(true)
	.withLogFooter(true);
