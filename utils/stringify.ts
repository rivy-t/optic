 ...
 */
function createReplacer(options: StringifyOptions | undefined): StandardReplacer {
	...
	return function replace(this: Record<string, unknown>, key: string, value: unknown) {
			...
			if (cache.length) {
				...
				if (valueCutoff !== 0) {
					return hasCircularReplacer
						? options!.circularReplacer!.call(this, key, value, getReferenceKey(keys, valueCutoff))
 ...
 */
export function stringify(value: unknown, options?: StringifyOptions) {
